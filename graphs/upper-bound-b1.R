...
bond_portfolio_solution <- bond_portfolio +
  geom_point(aes(x=0.5, y=0.5), color = "black") +
  geom_text(aes(x=0.5, y=0.5), label="(0.5, 0.5)", vjust=-.5, hjust=0) +
  stat_function(fun = function(x) {(4*0.5 + 3*0.5 - 4*x)/3}, color = "black")
